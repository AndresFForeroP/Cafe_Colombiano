...
namespace Cafe_Colombiano.src.Modules.Variedad.Infrastructure.Repository
{
    public class VariedadRepository : IVariedadRepository
    {
        ...
        ==============================
        """);
            Console.WriteLine("Ingrese un numero segun la Densidad de siembra del grano que desea buscar");
            int porte = validarentero(5);
            switch (porte)
            {
                case 1:
        ...
        ==============================
        """);
            Console.WriteLine("Ingrese un numero segun la Geupo Genetico de siembra del grano que desea buscar");
            int porte = validarentero(5);
            switch (porte)
            {
                case 1:
